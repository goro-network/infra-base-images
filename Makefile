...
TAG_NATIVE_CI		:=	${TAG_PREFIX}/native-ghrunner:${VER_WORKERS}-${CPU_ARCH_TAG}
TAG_NATIVE_CI_LATEST	:=	${TAG_PREFIX}/native-ghrunner:latest-${CPU_ARCH_TAG}
TAG_NATIVE_BASE		:=	${TAG_PREFIX}/native-base:${RS_STABLE}-${CPU_ARCH_TAG}
TAG_NATIVE_BASE_LATEST	:=	${TAG_PREFIX}/native-base:latest-${CPU_ARCH_TAG}
